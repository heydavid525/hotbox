...
_FEATURESTATPROTO = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='unique_cat_values', full_name='hotbox.FeatureStatProto.unique_cat_values', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='unique_bytes_values', full_name='hotbox.FeatureStatProto.unique_bytes_values', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='min', full_name='hotbox.FeatureStatProto.min', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='max', full_name='hotbox.FeatureStatProto.max', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='sum', full_name='hotbox.FeatureStatProto.sum', index=4,
...
_FEATURE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='store_offset', full_name='hotbox.Feature.store_offset', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='global_offset', full_name='hotbox.Feature.global_offset', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='is_factor', full_name='hotbox.Feature.is_factor', index=4,
...
_DATUMPROTOSTOREOFFSET = _descriptor.Descriptor(
  name='DatumProtoStoreOffset',
  full_name='hotbox.DatumProtoStoreOffset',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='offsets', full_name='hotbox.DatumProtoStoreOffset.offsets', index=0,
      number=1, type=3, cpp_type=2, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_FEATUREFAMILYPROTO = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='global_idx', full_name='hotbox.FeatureFamilyProto.global_idx', index=2,
...
_SELFCONTAINEDFEATUREFAMILYPROTO_NAMETOFAMILYIDXENTRY = _descriptor.Descriptor(
  name='NameToFamilyIdxEntry',
  full_name='hotbox.SelfContainedFeatureFamilyProto.NameToFamilyIdxEntry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='hotbox.SelfContainedFeatureFamilyProto.NameToFamilyIdxEntry.key', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='value', full_name='hotbox.SelfContainedFeatureFamilyProto.NameToFamilyIdxEntry.value', index=1,
      number=2, type=3, cpp_type=2, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_SELFCONTAINEDFEATUREFAMILYPROTO = _descriptor.Descriptor(
  name='SelfContainedFeatureFamilyProto',
  full_name='hotbox.SelfContainedFeatureFamilyProto',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='family_name', full_name='hotbox.SelfContainedFeatureFamilyProto.family_name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='name_to_family_idx', full_name='hotbox.SelfContainedFeatureFamilyProto.name_to_family_idx', index=1,
      number=2, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='features', full_name='hotbox.SelfContainedFeatureFamilyProto.features', index=2,
  ...
  nested_types=[_SELFCONTAINEDFEATUREFAMILYPROTO_NAMETOFAMILYIDXENTRY, ],
  enum_types=[
  ],
  options=None,
  is_extendable=False,
...
_SCHEMACONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='num_unique_values_factor', full_name='hotbox.SchemaConfig.num_unique_values_factor', index=2,
...
_SCHEMAPROTO = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='append_store_offset', full_name='hotbox.SchemaProto.append_store_offset', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='features', full_name='hotbox.SchemaProto.features', index=4,
      number=4, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_SELFCONTAINEDFEATUREFAMILYPROTO_NAMETOFAMILYIDXENTRY.containing_type = _SELFCONTAINEDFEATUREFAMILYPROTO
_SELFCONTAINEDFEATUREFAMILYPROTO.fields_by_name['name_to_family_idx'].message_type = _SELFCONTAINEDFEATUREFAMILYPROTO_NAMETOFAMILYIDXENTRY
_SELFCONTAINEDFEATUREFAMILYPROTO.fields_by_name['features'].message_type = _FEATURE
...
_SCHEMAPROTO.fields_by_name['append_store_offset'].message_type = _DATUMPROTOSTOREOFFSET
_SCHEMAPROTO.fields_by_name['features'].message_type = _FEATURE
...
DESCRIPTOR.message_types_by_name['DatumProtoStoreOffset'] = _DATUMPROTOSTOREOFFSET
DESCRIPTOR.message_types_by_name['FeatureFamilyProto'] = _FEATUREFAMILYPROTO
DESCRIPTOR.message_types_by_name['SelfContainedFeatureFamilyProto'] = _SELFCONTAINEDFEATUREFAMILYPROTO
...
DatumProtoStoreOffset = _reflection.GeneratedProtocolMessageType('DatumProtoStoreOffset', (_message.Message,), dict(
  DESCRIPTOR = _DATUMPROTOSTOREOFFSET,
  __module__ = 'schema.proto.schema_pb2'
  # @@protoc_insertion_point(class_scope:hotbox.DatumProtoStoreOffset)
  ))
_sym_db.RegisterMessage(DatumProtoStoreOffset)
...
SelfContainedFeatureFamilyProto = _reflection.GeneratedProtocolMessageType('SelfContainedFeatureFamilyProto', (_message.Message,), dict(

  NameToFamilyIdxEntry = _reflection.GeneratedProtocolMessageType('NameToFamilyIdxEntry', (_message.Message,), dict(
    DESCRIPTOR = _SELFCONTAINEDFEATUREFAMILYPROTO_NAMETOFAMILYIDXENTRY,
    __module__ = 'schema.proto.schema_pb2'
    # @@protoc_insertion_point(class_scope:hotbox.SelfContainedFeatureFamilyProto.NameToFamilyIdxEntry)
    ))
  ,
  DESCRIPTOR = _SELFCONTAINEDFEATUREFAMILYPROTO,
  __module__ = 'schema.proto.schema_pb2'
  # @@protoc_insertion_point(class_scope:hotbox.SelfContainedFeatureFamilyProto)
  ))
_sym_db.RegisterMessage(SelfContainedFeatureFamilyProto)
_sym_db.RegisterMessage(SelfContainedFeatureFamilyProto.NameToFamilyIdxEntry)
...
_SELFCONTAINEDFEATUREFAMILYPROTO_NAMETOFAMILYIDXENTRY.has_options = True
_SELFCONTAINEDFEATUREFAMILYPROTO_NAMETOFAMILYIDXENTRY._options = _descriptor._ParseOptions(descriptor_pb2.MessageOptions(), b'8\001')
