...
class TransformOutputRange : public ::google::protobuf::Message {
 public:
  ...
  void clear_offset_begin();
  static const int kOffsetBeginFieldNumber = 1;
  ::google::protobuf::int64 offset_begin() const;
  void set_offset_begin(::google::protobuf::int64 value);

  // optional int64 offset_end = 2;
  void clear_offset_end();
  static const int kOffsetEndFieldNumber = 2;
  ::google::protobuf::int64 offset_end() const;
  void set_offset_end(::google::protobuf::int64 value);
 ...
 private:
  ...
  ::google::protobuf::internal::InternalMetadataWithArena _internal_metadata_;
  bool _is_default_instance_;
  ::google::protobuf::int64 offset_begin_;
  ::google::protobuf::int64 offset_end_;
  int store_type_;
  mutable int _cached_size_;
  friend void  protobuf_AddDesc_db_2fproto_2fdb_2eproto();
  friend void protobuf_AssignDesc_db_2fproto_2fdb_2eproto();
...
class SessionProto : public ::google::protobuf::Message {
 public:
  ...
  const ::hotbox::FeatureFamilyProto& internal_family_proto() const;
  ::hotbox::FeatureFamilyProto* mutable_internal_family_proto();
  ::hotbox::FeatureFamilyProto* release_internal_family_proto();
  void set_allocated_internal_family_proto(::hotbox::FeatureFamilyProto* internal_family_proto);
 ...
 private:
  ...
  ::hotbox::FeatureFamilyProto* internal_family_proto_;
  ::hotbox::FileMap* file_map_;
  int compressor_;
  int output_store_type_;
...
// optional double mean = 1;
inline void FeatureStatProto::clear_mean() {
  mean_ = 0;
}
inline double FeatureStatProto::mean() const {
  // @@protoc_insertion_point(field_get:hotbox.FeatureStatProto.mean)
  return mean_;
}
inline void FeatureStatProto::set_mean(double value) {
...
// optional double std = 2;
inline void FeatureStatProto::clear_std() {
  std_ = 0;
}
inline double FeatureStatProto::std() const {
  // @@protoc_insertion_point(field_get:hotbox.FeatureStatProto.std)
  return std_;
}
inline void FeatureStatProto::set_std(double value) {
...
// optional int64 offset_begin = 1;
inline void TransformOutputRange::clear_offset_begin() {
  offset_begin_ = GOOGLE_LONGLONG(0);
}
inline ::google::protobuf::int64 TransformOutputRange::offset_begin() const {
  // @@protoc_insertion_point(field_get:hotbox.TransformOutputRange.offset_begin)
  return offset_begin_;
}
inline void TransformOutputRange::set_offset_begin(::google::protobuf::int64 value) {
...
// optional int64 offset_end = 2;
inline void TransformOutputRange::clear_offset_end() {
  offset_end_ = GOOGLE_LONGLONG(0);
}
inline ::google::protobuf::int64 TransformOutputRange::offset_end() const {
  // @@protoc_insertion_point(field_get:hotbox.TransformOutputRange.offset_end)
  return offset_end_;
}
inline void TransformOutputRange::set_offset_end(::google::protobuf::int64 value) {
...
inline const ::hotbox::FeatureFamilyProto& SessionProto::internal_family_proto() const {
...
inline ::hotbox::FeatureFamilyProto* SessionProto::mutable_internal_family_proto() {
...
inline ::hotbox::FeatureFamilyProto* SessionProto::release_internal_family_proto() {
  
  ::hotbox::FeatureFamilyProto* temp = internal_family_proto_;
  internal_family_proto_ = NULL;
  return temp;
}
inline void SessionProto::set_allocated_internal_family_proto(::hotbox::FeatureFamilyProto* internal_family_proto) {
